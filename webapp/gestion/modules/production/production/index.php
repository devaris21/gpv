                            ...
                            <div class="tabs-left">
                                <ul class="nav nav-tabs">
                                 <?php foreach (Home\PRODUIT::getAll() as $key => $produit) { ?>
                                    <li style="border-bottom: 5px solid <?= $produit->couleur; ?>"><a class="nav-link text-uppercase" data-toggle="tab" href="#tab-<?= $produit->getId() ?>">rapport de production de<br> <?= $produit->name(); ?></a></li>
                                <?php }  ?>
                            </ul>
                                                                ...
                                                                foreach ($production->ligneproductionjours as $key => $ligne) {
                                                                    if ($pdv->getId() == $ligne->prixdevente_id) { 
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <h4 class="d-inline text-green gras"><?= start0($pdv->vendu($production->ladate, $production->ladate)) ?></h4>&nbsp;&nbsp;|&nbsp;&nbsp;
