                           ...
                           <div>
                            ...
                            <div class="row">
                                <div class="col-6">
                                    ...
                                    <h5><span>Heure de depart :</span> <span class="text-uppercase"><?= datelong($prospection->created) ?></span></h5>     
                                </div>
                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    <?php foreach ($prospection->lignedeventes as $key => $ligne) {
                                        $ligne->actualise(); ?>
                                        <tr>
                                            <td width="70">
                                            ...
                                            <td class="text-center"><br><h2><?= ($prospection->etat_id == Home\ETAT::VALIDEE)? $ligne->quantite_livree : "" ?></h2></td>
                                            <td class="text-center text-red"><br><h3><h3><?= ($prospection->etat_id == Home\ETAT::VALIDEE) ? start0($ligne->quantite - $ligne->quantite_livree) : "" ?></h3></td>
